...
def crossoff_movie():
    ...
    if crossed_off_movie not in watch_list:
    ...
    watch_list.remove(crossed_off_movie)
...
def index():
    ...
    return render_template('edit.html', watchlist=watch_list, error=encoded_error and cgi.escape(encoded_error, quote=True))
